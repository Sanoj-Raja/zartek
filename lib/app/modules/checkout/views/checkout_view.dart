                                  ...
                                  child: Text(
                                    '${[
                                      ...{...ITEMS_IN_CART}
                                          ...
                                          ...{...ITEMS_IN_CART}
                                        ].length > 1 ? 'DISHES' : 'DISH'} & ${ITEMS_IN_CART.length} - ${ITEMS_IN_CART.length > 1 ? 'ITEMS' : 'ITEM'}',
                                    style: Get.textTheme.headline2!.copyWith(
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Obx(
                                      () => Text(
                                        '${AppStrings.inr} ${ITEMS_IN_CART.fold(0.0, (double previousValue, dish) => (previousValue + dish.dishPrice!))}',
                                        style:
